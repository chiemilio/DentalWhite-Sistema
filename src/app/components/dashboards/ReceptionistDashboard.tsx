...
import { workCenters, type Appointment } from '../../data/mockData';
...
import { apiClient, type BackendAppointment, type BackendPatient } from '../../utils/api';

console.log('=== ReceptionistDashboard module loaded ==='); 
...
export function ReceptionistDashboard() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        if (selectedDate) {
          params.append('fecha_inicio', selectedDate);
          params.append('fecha_fin', selectedDate);
        }
        ...
        const data = await apiClient.get<BackendAppointment[]>(endpoint, true);
        setBackendAppointments(data);
  ...
  const filteredAppointments = appointments.filter((apt) => {
    // Temporarily show all appointments regardless of date
