...
import { apiClient, type BackendAppointment, type BackendCatalogItem } from '../../utils/api';
...
export function PatientDashboard() {
  ...
  useEffect(() => {
    const fetchCatalogs = async () => {
      try {
        const estadosData = await apiClient.get<BackedCatalogItem[]>('/catalogos/estados-cita');
